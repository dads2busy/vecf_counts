...
column_valid_values <- "Values of length 7 are acceptable. "
```
...
# get record details
  invalid_details <-
    cust_by_yr[is_blank(unique_id)|nchar(unique_id) != 7,
               c("unique_id", "service_duration", "service_placement_type" )] 
