...
column_valid_values <-  dictionary[agency_name == "Office of Childrens Services"][view_name == "OCS Services By Year"][column_name == "Clinical Medication"][, c("value", "description")]
```
