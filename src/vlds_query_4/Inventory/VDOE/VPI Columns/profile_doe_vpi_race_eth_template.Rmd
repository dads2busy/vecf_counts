...
column_name = "student's race/ethnicity"
table_name = "DOE Preschool Initiative"
...
column_valid_values <-  dictionary[agency_name == "Virginia Department of Education"][view_name == "VPI+"][column_name == "Student's Race/Ethnicity"][,c("value", "description")]
```


<!--UNIQUENESS-->
```{r uniqueness, include=FALSE, eval=uniqueness_print}
values <-  cust_by_yr[!is_blank(students_race_ethnicity)|students_race_ethnicity %in% as.character(c(1:8)), students_race_ethnicity]
...
missing <- cust_by_yr[is_blank(students_race_ethnicity), .N]
...
invalid = cust_by_yr[is_blank(students_race_ethnicity)|!students_race_ethnicity %in% as.character(c(1:8)), .N]
...
# get record details
  invalid_details <-
    cust_by_yr[is_blank(students_race_ethnicity)|!students_race_ethnicity %in% as.character(c(1:8)),
               c("unique_id", "students_race_ethnicity", "school" )] 
