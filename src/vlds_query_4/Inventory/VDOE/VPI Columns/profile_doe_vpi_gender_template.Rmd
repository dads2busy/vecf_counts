...
column_valid_values <- dictionary[agency_name == "Virginia Department of Education"][view_name == "VPI+"][column_name == "Gender"][,c("value", "description")]
```


<!--UNIQUENESS-->
```{r uniqueness, include=FALSE, eval=uniqueness_print}
values <-  cust_by_yr[!is_blank(gender)|gender %in% c("M", "F"), gender]
...
invalid = cust_by_yr[is_blank(gender)|!gender %in% c("F", "M"), .N]
...
# get record details
  invalid_details <-
    cust_by_yr[is_blank(gender)|!gender %in% c("F", "M"),
