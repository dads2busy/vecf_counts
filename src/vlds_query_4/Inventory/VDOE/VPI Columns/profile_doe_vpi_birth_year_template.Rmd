...
column_valid_values <- tibble::tibble("Year" = c(2010:2012))
  #dictionary[agency_name == "Virginia Department of Education"][view_name == "VPI+"][column_name == "Birth Month"][,c("value", "description")]
```


<!--UNIQUENESS-->
```{r uniqueness, include=FALSE, eval=uniqueness_print}
values <-  cust_by_yr[!is_blank(birth_year), birth_year]
