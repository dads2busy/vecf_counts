...
column_name = "welfare status flag"
...
column_valid_values <- c("N", "Y")
```


<!--UNIQUENESS-->
```{r uniqueness, include=FALSE, eval=uniqueness_print}
values <-  cust_by_yr[!is_blank(welfare_status_flag)|welfare_status_flag %in% c("N", "Y"), welfare_status_flag]
...
missing <- cust_by_yr[is_blank(welfare_status_flag), .N]
...
invalid = cust_by_yr[is_blank(welfare_status_flag)|!welfare_status_flag %in% c("N", "Y"), .N]
...
# get record details
  invalid_details <-
    cust_by_yr[is_blank(welfare_status_flag)|!welfare_status_flag %in% c("N", "Y"),
               c("unique_id", "welfare_status_flag", "school" )] 
