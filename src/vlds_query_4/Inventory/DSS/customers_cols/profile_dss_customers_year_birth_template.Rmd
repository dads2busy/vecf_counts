...
column_valid_values <-  as.character(c(1900:2019))
...
longitudinal_inconsistent_1 <- 
  cust_by_year[, .N , by = c("uniqueID", "year_of_birth")][N>1,][,.N]
...
unique_id_list <- 
  cust_by_year[, .N , by = c("uniqueID", "year_of_birth")][N>1,uniqueID]
  

# get record details
longitudinal_inconsistent_1_details <- cust_by_year[uniqueID %in% unique_id_list,c("uniqueID", "year_of_birth")]
