---
title: "Profile Dataset: DSS TANF Customers By Year"
...
```{r, include=FALSE}
dt_unprepared <- fread(here("data/original/q5/DSS/DSS TANF Customer by Year.csv"), colClasses = "character")
dt <- fread(here("data/working/DSS/dss_tanf_customers_by_year.csv"), colClasses = "character")
```
## Dataset Preparation
